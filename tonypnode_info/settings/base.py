"""
Django settings for tonypnode_info project.
...
INSTALLED_APPS = [
    ...
    'tonyp_webfront.apps.TonypWebfrontConfig',
]
...
ROOT_URLCONF = 'tonypnode_info.urls'
...
WSGI_APPLICATION = 'tonypnode_info.wsgi.application'
